...
if msg.text == "کینگ" and is_sudo(msg) then
...
if msg.text == "ali" and is_sudo(msg) then
	return
end
if msg.text == "sina" and is_sudo(msg) then
	return
end
if msg.text == "علی" and is_sudo(msg) then
	return
end


if msg.text == "sina" then
